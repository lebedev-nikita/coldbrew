...
const en = {
  ...
  russian: "Russian",
  activeDevelopment:
    "Omnistream is under active development. Breaking changes and data loss are possible.",
  ...
  secureAuthorization: "Sign in to DonationAlerts to securely grant Omnistream access.",
  moreIntegrations: "More integrations are coming soon.",
...
const ru = defineTranslations({
  ...
  russian: "Русский",
  activeDevelopment:
    "Omnistream находится в активной разработке. Возможны несовместимые изменения и потеря данных.",
  ...
  secureAuthorization: "Войдите в DonationAlerts и безопасно предоставьте Omnistream доступ.",
  moreIntegrations: "Скоро появятся другие интеграции.",
